...
class FoodOrdersControllerTest < ActionController::TestCase
  ...
  test "should create food_order" do
    assert_difference('FoodOrder.count') do
      post :create, food_order: { name: @food_order.name, price: @food_order.price, quantity: @food_order.quantity, state: @food_order.state, takeaway: @food_order.takeaway }
    end
  ...
  test "should update food_order" do
    patch :update, id: @food_order, food_order: { name: @food_order.name, price: @food_order.price, quantity: @food_order.quantity, state: @food_order.state, takeaway: @food_order.takeaway }
    assert_redirected_to food_order_path(assigns(:food_order))
  end
